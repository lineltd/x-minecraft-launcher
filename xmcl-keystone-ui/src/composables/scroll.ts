import { ComponentPublicInstance, Ref, onMounted } from 'vue'

export function useScrollToOnMount(elem: Ref<null | ComponentPublicInstance | HTMLElement>, computeOffset: () => number) {
  onMounted(() => {
